...
import type { Departament } from "../api/departaments";
...
export default function DepartamentPage() {
    ...
    // =========================
    // UPDATE / EDITAR DEPARTAMENT
    // =========================
    async function onEdit(c: Departament) {
            ...
            <main className="mx-auto max-w-5xl px-4 py-6 space-y-4">
                ...
                >
                    <p className="text-sm text-slate-600">
                        <b>Mutation (POST)</b>: crea departamento y refresca listado.
                    </p>
